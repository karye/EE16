        ...
        <main>
            ...
            if (isset($_GET["id"])) {
                ...
                if (!$result) {
                    ...
                    echo "<p class=\"alert alert-dismissible alert-warning\">Vill du verkligen radera <strong>{$rad['fnamn']} {$rad['enamn']}</strong> från databasen? <a class=\"btn btn-danger\" href=\"radera-db.php?id={$rad['id']}\">Bekräfta</a></p>";
                }
